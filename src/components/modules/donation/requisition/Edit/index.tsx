...
export default function EditRequisitionComponent(props: EditRequisitionProps) {
  const { onChange, onSubmit, state, checked, select, setSelect, items, item } =
    props;

  const { amountPerQuantity, itemId, status, quality, quantity } = state;
